...
## 安装/更新 最新版golang
```
source <(curl -L https://raw.githubusercontent.com/gagmm/go-install/refs/heads/master/install.sh)
```

## 安装/更新 指定版本golang
```
source <(curl -L https://raw.githubusercontent.com/gagmm/go-install/refs/heads/master/install.sh) -v 1.13.5
``` 

## 强制更新golang
默认更新策略是已有版本和最新版本一样就不去更新, 要强制更新添加-f
```
source <(curl -L https://raw.githubusercontent.com/gagmm/go-install/refs/heads/master/install.sh) -f
```
